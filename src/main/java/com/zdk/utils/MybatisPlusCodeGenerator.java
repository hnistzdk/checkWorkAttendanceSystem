...
public class MybatisPlusCodeGenerator {
    public static void main(String[] args) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost:3306/check_work_attendance_system?serverTimezone=UTC&useSSL=false&useUnicode=true&characterEncoding=utf8");
        ...
        //设置要(读取)映射的表
        strategyConfig.setInclude("check_info","permission","role","user");
        //设置要去掉的表的前缀
